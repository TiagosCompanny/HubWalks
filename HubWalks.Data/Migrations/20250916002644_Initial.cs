        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SdrBdrId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_OrdensDeServico_Clientes_IdClient",
                        column: x => x.IdClient,
                        principalTable: "Clientes",
                        principalColumn: "IdCliente",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrdensDeServico_Sdr_Bdrs_SdrBdrId",
                        column: x => x.SdrBdrId,
                        principalTable: "Sdr_Bdrs",
                        principalColumn: "IdSdr_Bdr",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "role-admin", "688e0e66-1a84-4183-8be3-6fa6fcfe074b", "Admin", "ADMIN" },
                    { "role-user", "d5b81047-592a-4b55-94da-72403f80f413", "User", "USER" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrdensDeServico_IdClient",
                table: "OrdensDeServico",
                column: "IdClient");

            migrationBuilder.CreateIndex(
                name: "IX_OrdensDeServico_SdrBdrId",
                table: "OrdensDeServico",
                column: "SdrBdrId");
        }
